...
import { updateNewEmailOTP } from "../../../store/actions/authAction";
...
function UpdateOTP(props) {
  ...
  // console.log("UPDATE EMAIL OTPP PROPS", props.newEmail)
  const loggedemail = props.newEmail
  ...
  const handleSubmit = (e) => {
    ...
    props.updateNewEmailOTP(SIGNUPOTP_DATA, () => {
      props.history.push({
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Button
              ...
              disabled={!state.OTPpin  || stateLoader}
            >
              {stateLoader ? (
...
const mapStateToProps = (state) => {
  console.log("UPDATE OTP STATE", state)
  return {
    newEmail: state.auth.newEmailData
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    updateNewEmailOTP: (SIGNUPOTP_DATA, navigate, stopLoader) => dispatch(updateNewEmailOTP(SIGNUPOTP_DATA, navigate, stopLoader))
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(UpdateOTP);
